            ...
            <div class="box-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th style="width: 300px">vip等级</th>
                        <th style="width: 300px">vip过期时间</th>
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($itm["nickname"]); ?></td>
                            <td><?php echo ($itm["vip_text"]); ?></td>
                            <td><?php echo ($itm["vip_expire"]); ?></td>
                            <td><a href="javascript:void(0)" class="itm-edit" val="<?php echo ($itm["id"]); ?>">明细</a></td>
...
//                            alert(result.msg);
            ...
            $('.itm-edit').click(function() {
                ...
                location.href = '/admin/manage/customer_edit?id='+ id;
            });
