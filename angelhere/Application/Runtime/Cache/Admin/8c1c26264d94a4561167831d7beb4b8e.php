    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <!--<div class="col-md-2" style="padding: 20px;">-->
                <!--<a class="btn btn-block btn-primary add_lesson_btn" href="javascript:void(0)">添加教练</a>-->
            <!--</div>-->
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th style="width: 300px">级别</th>
                        <th style="width: 300px">标签</th>
                        <th style="width: 100px">操作</th>
                        <th>删除</th>
                    </tr>

                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($itm["config_id"]); ?></td>
                            <td><?php echo ($itm["Name"]); ?></td>
                            <!--<td><?php echo ($itm["lesson"]); ?></td>-->
                            <!--<td><?php echo ($itm["age"]); ?></td>-->
                            <td><?php echo ($itm["title"]); ?></td>
                            <td><?php echo ($itm["label"]); ?></td>
                            <td><a href="javascript:void(0)" class="itm-edit" val="<?php echo ($itm["config_id"]); ?>">编辑</a></td>
                            <td><a href="javascript:void(0)" class="itm-del" val="<?php echo ($itm["config_id"]); ?>">删除</a></td>
...
//                            alert(JSON.stringify(result));
            ...
            $('.itm-edit').click(function() {
                ...
                location.href = '/admin/manage/coach_edit?id='+ id;
            });

            $('.add_lesson_btn').click(function(){
                location.href = '/admin/manage/lesson_edit?id=0';
            });
        });
    </script>
