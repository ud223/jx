    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="col-md-2" style="padding: 20px;">
                <a class="btn btn-block btn-primary add_lesson_btn" href="javascript:void(0)">添加课程</a>
            </div>
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th style="width: 250px">英文名称</th>
                        <th style="width: 100px">展示图片</th>
                        <th style="width: 300px">地址</th>
                        <th style="width: 100px">操作</th>
                        <th>删除</th>
                    </tr>

                    <?php if(is_array($data["lesson"])): $i = 0; $__LIST__ = $data["lesson"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($itm["id"]); ?></td>
                            <td><?php echo ($itm["name"]); ?></td>
                            <td><?php echo ($itm["name_en"]); ?></td>
                            <td><?php echo ($itm["show_pic"]); ?></td>
                            <td><?php echo ($itm["local"]); ?></td>
    ...
    <script>
        $(function(){
            ...
            $('.itm-edit').click(function() {
                ...
                location.href = '/admin/manage/lesson_edit?id='+ id;
            });
