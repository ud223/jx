        ...
        <div class="box">
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <?php if(is_array($data["order"])): $i = 0; $__LIST__ = $data["order"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($itm["id"]); ?></td>
                            <td><?php echo ($itm["name"]); ?></td>
                            <td><?php echo ($itm["tel"]); ?></td>
                            <td><?php echo ($itm["lesson_name"]); ?></td>
                            <td><?php echo ($itm["run_date"]); ?></td>
                            <td><?php echo ($itm["start_time"]); ?></td>
                            <td><?php echo ($itm["local"]); ?></td>
                            <td><a href="javascript:void(0)" class="itm-edit" val="<?php echo ($itm["order_id"]); ?>">查看</a></td>
