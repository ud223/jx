            ...
            <div class="am-modal-bd">
                <div style="width: 60%;margin: auto;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" readonly="readonly" name="name_field" id="name_field" value="<?php echo ($data["user"]["Name"]); ?>" maxlength="50">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">昵称</span>
                        <input type="text" class="form-control" readonly="readonly" name="nick_name_field" id="nick_name_field" value="<?php echo ($data["user"]["NickName"]); ?>" maxlength="50">
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon">vip等级</span>
                        <input type="text" class="form-control" readonly="readonly" name="vip_field" id="vip_field" value="<?php echo ($data["user"]["vip"]); ?>" maxlength="50">
                        <!--<select>-->
                            <!--<option value="0">普通用户</option>-->
                            <!--<?php if(is_array($data["vip"])): $i = 0; $__LIST__ = $data["vip"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?>-->
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" readonly="readonly" name="amount_field" id="amount_field" value="<?php echo ($data["user"]["amount"]); ?>" maxlength="50">
                    </div>
                </div>
            </div>
            <div class="am-modal-footer">
                <input type="hidden" id="vip_type_id" value="<?php echo ($data["user"]["id"]); ?>">
