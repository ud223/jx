            ...
            <div class="am-modal-bd">
                <div style="width: 60%;margin: auto;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="请输入vip类型名称..." name="name_field" id="name_field" value="<?php echo ($data[vip_type]["name"]); ?>" maxlength="50">
                    </div>
                </div>
            </div>
            <div class="am-modal-footer">
                <input type="hidden" id="vip_type_id" value="<?php echo ($data['vip_type']['id']); ?>">
