    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <?php foreach ($model as $item) :?>
                <li class="treeview">
                    <li><a href="javascript:void(0)"><i class="fa fa-circle-o"></i><?php echo $item['name']; ?></a>
                        <ul class="treeview-menu">
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title">成员类型管理</h3>
            </div>

            <div class="col-md-2" style="padding: 20px;">
                <a class="btn btn-block btn-primary add_category_btn" href="/product/manage">添加类型</a>
            </div>
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th  style="width: 30px">用户类型</th>
                        <th style="width: 40px">操作</th>
                    </tr>
                    <?php if(is_array($data["member_type"])): $i = 0; $__LIST__ = $data["member_type"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
