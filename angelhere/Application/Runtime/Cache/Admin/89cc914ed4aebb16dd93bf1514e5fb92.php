    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="am-modal-bd">
                <div style="width: 60%;margin: auto;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="请输入姓名..." name="name_field" id="name_field" value="<?php echo ($data['coach']["Name"]); ?>" maxlength="50">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">级别</span>
                        <input type="text" class="form-control" placeholder="请输入级别..." name="title_field" id="title_field" value="<?php echo ($data['coach_config']["title"]); ?>" maxlength="100">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">标签</span>
                        <input type="text" class="form-control" placeholder="请输入标签..." name="label_field" id="label_field" value="<?php echo ($data[coach_config]["label"]); ?>" maxlength="100">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">价格</span>
                        <input type="text" class="form-control" placeholder="请输入价格..." name="price_field" id="price_field" value="<?php echo ($data[coach_config]["price"]); ?>" maxlength="100">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">vip价格</span>
                        <input type="text" class="form-control" placeholder="请输入vip价格..." name="price_vip1_field" id="price_vip1_field" value="<?php echo ($data[coach_config]["price_vip1"]); ?>" maxlength="100">
                    </div>
                    <div class="input-group">
                    ...
                    <div class="input-group">
                        ...
                        <input id="old_show_pic" name="old_show_pic" type="text" value="<?php echo ($data['coach_config']['show_pic']); ?>" style="display: none">
                    ...
                    <div class="input-group">
                        ...
                        <input id="old_show_pic_big" name="old_show_pic_big" type="text" value="<?php echo ($data['coach_config']['show_pic_big']); ?>" style="display: none">
            ...
            <div class="am-modal-footer">
                <input type="hidden" id="coach_id" value="<?php echo ($data['coach_config']['id']); ?>">
...
//            um.setContent('<?php echo ($data[lesson]["remark"]); ?>');
        ...
        function saveItem() {
            ...
            var data = { 'id':id, 'name':name, 'price':price, 'price_vip1':price_vip1, 'title':title, 'label':label, 'old_show_pic':old_show_pic, 'show_pic':show_pic, 'old_show_pic_big': old_show_pic_big, 'show_pic_big': show_pic_big };

//            alert(JSON.stringify(data));
//            return;

            if (confirm('是否保存该教练信息?')) {
                fit.ajax({
