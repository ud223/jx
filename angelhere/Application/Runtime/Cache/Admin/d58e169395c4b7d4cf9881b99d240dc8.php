    ...
    <div class="col-md-12">
        <div class="box">
            ...
            <div class="col-md-2" style="padding: 20px;">
                <a class="btn btn-block btn-primary add_vip_type_btn" href="javascript:void(0)">添加vip类型</a>
            </div>
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <?php if(is_array($data["vip_type"])): $i = 0; $__LIST__ = $data["vip_type"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
    ...
    <script>
        $(function(){
            $('.itm-del').click(function() {
                ...
                if (confirm('是否删除该vip类型?')) {
                    fit.ajax({
                        url:'/admin/manage/del_vip_type',
                        data:{
                            'id':id
                        },
            ...
            $('.itm-edit').click(function() {
                ...
                location.href = '/admin/manage/vip_type_edit?id='+ id;
            });

            $('.add_vip_type_btn').click(function(){
                location.href = '/admin/manage/vip_type_edit?id=0';
            });
        });
    </script>
