            ...
            <div class="am-modal-bd">
                <div style="width: 60%;margin: auto;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo ($data[order][0]["name"]); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">电话</span>
                        <input type="text" class="form-control" value="<?php echo ($data[order][0]["tel"]); ?>" readonly>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">课程</span>
                        <input type="text" class="form-control" value="<?php echo ($data[order][0]["lesson_name"]); ?>" readonly>
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon">预约日期</span>
                        <input type="text" class="form-control" value="<?php echo ($data[order][0]["run_date"]); ?>" readonly>
                    </div>

                    <div class="input-group">
                        <span class="input-group-addon">上课时间</span>
                        <input type="text" class="form-control" value="<?php echo ($data[order][0]["start_time"]); ?>" readonly>
                    </div>
