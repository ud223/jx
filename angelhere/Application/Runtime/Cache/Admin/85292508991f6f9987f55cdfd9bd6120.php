            ...
            <div class="am-modal-bd">
                <div style="width: 60%;margin: auto;">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week1_field" id="week1_field" value="<?php echo ($data[0]["time"]); ?>">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">星期二</span>
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week2_field" id="week2_field" value="<?php echo ($data[1]["time"]); ?>">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">星期三</span>
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week3_field" id="week3_field" value="<?php echo ($data[2]["time"]); ?>">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">星期四</span>
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week4_field" id="week4_field" value="<?php echo ($data[3]["time"]); ?>">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">星期五</span>
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week5_field" id="week5_field" value="<?php echo ($data[4]["time"]); ?>">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">星期六</span>
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week6_field" id="week6_field" value="<?php echo ($data[5]["time"]); ?>">
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">星期天</span>
                        <input type="text" class="form-control" placeholder="请输入锻炼时段..." name="week7_field" id="week7_field" value="<?php echo ($data[6]["time"]); ?>">
                    </div>
                </div>
            </div>
            <div class="am-modal-footer">
                <input type="hidden" id="coach_id" value="<?php echo ($data['coach'][0]['id']); ?>">
