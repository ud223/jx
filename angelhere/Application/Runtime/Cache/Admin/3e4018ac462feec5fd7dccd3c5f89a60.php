            ...
            <div class="box-body">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th style="width: 40px">登录名</th>
                        <th style="width: 40px">电话</th>
                        <th style="width: 40px">地区</th>
                        <th style="width: 100px;">街道</th>
                        <th style="width: 100px;">操作</th>
                    </tr>

                    <?php if(is_array($data["member"])): $i = 0; $__LIST__ = $data["member"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$itm): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($itm["uid"]); ?></td>
