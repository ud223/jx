...
<!--    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>-->
    ...
    <title><?php echo ($current['title']); echo (C("sitename")); ?></title>
    ...
    <link rel="stylesheet" href="/Public/qwadmin/css/font-awesome.css?v=1200.01"/>
    ...
    <script src="/Public/qwadmin/js/qrcode2.js"></script>
</head>
<body class="no-skin">
    ...
    <div class="main-content">
        ...
        <ul class="breadcrumb">
            ...
            <?php if(isset($current['ptitle'])): ?><li>
                    <?php echo ($current['ptitle']); ?><!--<a href="#"></a>-->
                </li><?php endif; ?>
            <li class="active"><a href="<?php echo ($list_uri); ?>"><?php echo ($current['title']); ?></a></li>
        </ul><!-- /.breadcrumb -->
    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <input type="hidden" name="aid" value="<?php echo ($item["id"]); ?>" id="aid"/>
                            <div class="space-4"></div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label no-padding-right" for="form-field-1">
                                    经纬度: </label>
                                <div class="col-sm-9">
                                    <input type="text" name="lng" id="lng" placeholder="经度" style="width:150px;" value="<?php echo ($item['lng']); ?>">
                                    <!--<span class="help-inline col-xs-1 col-sm-1">-->
                                        <span class="middle">-</span>
                                    <!--</span>-->
                                    <input type="text" name="lat" id="lat" placeholder="纬度" style="width:150px;" value="<?php echo ($item['lat']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="help-inline col-xs-4 col-sm-4">
                                        <input type="checkbox" name="not_for_country" id="not_for_country" <?php if($item["not_for_country"] == 1): ?>checked<?php endif; ?>><label class="middle" for="not_for_country">不属于国家</label>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="help-inline col-xs-7 col-sm-7">
                                        <input type="checkbox" name="not_for_province" id="not_for_province" <?php if($item["not_for_province"] == 1): ?>checked<?php endif; ?>> <label class="middle" for="not_for_province">不属于省份</label>
                                    </span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name_cn" id="name_cn" placeholder="中文名称"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($item['name_cn']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name_en" id="name_en" placeholder="英文名称"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($item['name_en']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name_jp" id="name_jp" placeholder="日文名称"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($item['name_jp']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="name_ger" id="name_ger" placeholder="德文名称"
                                           class="col-xs-10 col-sm-5" value="<?php echo ($item['name_ger']); ?>">
                                    <span class="help-inline col-xs-12 col-sm-7">
                                        <span class="middle"></span>
                                    </span>
                                </div>
    ...
    <div class="footer-inner">
        ...
        <div class="footer-content">
            <span class="bigger-120">
                <small>Copyright &copy; 2018 <a href="#" target="_blank"></a> All Rights Reserved.</small>
            </span>
        </div>
...
<script src="/Public/qwadmin/js/plugin.js"></script>
