                        ...
                        <div class="row">
                            <div class="cf">
                                ...
                                <select name="field" class="form-control">
                                    <option<?php if(I('field') == name): ?>selected<?php endif; ?> value="name">-请选择条件-</option>
                                    <option<?php if(I('field') == name): ?>selected<?php endif; ?> value="name">姓名</option>
                                    <option<?php if(I('field') == name): ?>selected<?php endif; ?> value="phone">电话</option>
                                    <option<?php if(I('field') == name): ?>selected<?php endif; ?> value="id_number">身份证</option>
                                    <option<?php if(I('field') == name): ?>selected<?php endif; ?> value="volunteer_number">义工号</option>
                                </select>
                            ...
                            <form id="form" method="post" action="<?php echo U('del');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    <?php if(is_array($consult)): $i = 0; $__LIST__ = $consult;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            <td class="center">
                                                <input class="ids" type="checkbox" name="id[]" value="<?php echo ($val['id']); ?>">
                                            </td>
                                            <!--<td><img  src="arr[<?php echo ($val['$image_arr']); ?>" /></td>-->
                                            <td><?php echo ($val['name']); ?></td>
                                            <td><?php echo ($val['phone']); ?></td>
                                            <td><?php echo ($val['id_number']); ?></td>
                                            ...
                                            <td class="center"><a href="<?php echo U('edit',array('id'=>$val['id']));?>">修改</a>&nbsp;<a
                                                    class="del" href="javascript:;" val="<?php echo U('del',array('id'=>$val['id']));?>"
                                                    title="删除">删除</a></td>
                                            <td>&nbsp;<a class="disable" href="javascript:;" val="<?php echo U('disable',array('id'=>$val['id']));?>"
                                                    title="删除">确认</a></td>
