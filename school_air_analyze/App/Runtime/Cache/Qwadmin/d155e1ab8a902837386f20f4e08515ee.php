                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php if(is_array($community_cooperate_login)): $i = 0; $__LIST__ = $community_cooperate_login;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="center"><input class="ids" type="checkbox" name="ids[]" value="<?php echo ($val['id']); ?>"></td>
                                    <td><?php echo ($val['name']); ?></td>
                                    <td><?php echo ($val['type']['name']); ?></td>
                                    <td class="center"><a href="<?php echo U('edit',array('id'=>$val['id']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>修改</a>  <a href="javascript:;" val="<?php echo U('del',array('aids'=>$val['id']));?>" class="del"><i
