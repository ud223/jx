                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <form class="form-inline" action="" method="get">
                                ...
                                <label class="inline">学校搜索</label>
                                <select name="field" class="form-control">
                                    <option <?php if(I('field') == name): ?>selected<?php endif; ?> value="name">学校名称</option>
                                    <option <?php if(I('field') == city): ?>selected<?php endif; ?> value="city">城市</option>
                                    <option <?php if(I('field') == region): ?>selected<?php endif; ?> value="region">行政区</option>
                                </select>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>                     
                                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                                ...
                                                <td class="center">
                                                    <?php if ($val['status']==1) { echo '正常'; } elseif ($val['status']==0) { echo '禁用'; } else { echo '已删除'; } ?>
                                                </td>
                                                <td class="center">
                                                    <a href="<?php echo U('edit',array('uid'=>$val['uid']));?>">修改</a>&nbsp;
                                                    <a class="del" href="javascript:;" val="<?php echo U('del',array('uid'=>$val['uid']));?>" title="删除">删除</a>
                                                </td>
