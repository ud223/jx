                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php if(is_array($community_cooperate)): $i = 0; $__LIST__ = $community_cooperate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="center"><input class="ids" type="checkbox" name="ids[]" value="<?php echo ($val['id']); ?>"></td>
                                    <td><?php echo ($val['user']['name']); ?></td>
                                    <td><?php echo ($val['state']['name']); ?></td>
                                    <td><?php echo ($val['fen']['name']); ?></td>
                                    <td><?php echo ($val['type']['name']); ?></td>
                                    <td><?php echo ($val['content']); ?></td>
                                    <td><?php echo ($val['time']); ?></td>
                                    <td class="center"><a href="<?php echo U('edit',array('id'=>$val['optid']));?>"><i
                                            class="ace-icon fa fa-pencil bigger-100"></i>查看</a>  </td>
                                </tr>
