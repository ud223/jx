...
return array(
    ...
    'DB_HOST'   => $_SERVER[ENV_PRE.'DB_HOST'] ? : '192.168.0.148', //服务器地址
    'DB_NAME'   => $_SERVER[ENV_PRE.'DB_NAME'] ? : 'jx', //数据库名
    'DB_USER'   => $_SERVER[ENV_PRE.'DB_USER'] ? : 'root', //用户名
    'DB_PWD'    => $_SERVER[ENV_PRE.'DB_PWD']  ? : '1111',  //密码
    'DB_PORT'   => $_SERVER[ENV_PRE.'DB_PORT'] ? : '3306', //端口
    'DB_PREFIX' => $_SERVER[ENV_PRE.'DB_PREFIX'] ? : 'jx_', //数据库表前缀
