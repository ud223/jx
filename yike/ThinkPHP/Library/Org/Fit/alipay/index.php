	...
	<div class="header">
		...
		<div class="container">
			<div class="nav">
				...
				<a href="http://open.alipay.com/platform/home.htm" class="open" target="_blank">交易平台</a>
				<ul class="navbar">
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			<div class="element" style="margin-top:60px;">
				<div class="legend">E客电动支付宝支付 </div>
			</div>
			<div class="element">
				<div class="etitle">商户订单号:</div>
				<div class="einput"><input type="text" name="WIDout_trade_no" id="out_trade_no" readonly></div>
				<br>
<!--				<div class="mark">注意：商户订单号(out_trade_no).必填(建议是英文字母和数字,不能含有特殊字符)</div>-->
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDsubject" id="WIDsubject" value="" readonly></div>
				<br>
<!--				<div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>-->
			</div>
			<div class="element">
				<div class="etitle">付款金额:</div>
				<div class="einput"><input type="text" name="WIDtotal_fee" id="WIDtotal_fee" value="" readonly></div>
				<br>
<!--				<div class="mark">注意：付款金额(total_fee)，必填(格式如：1.00,请精确到分)</div>-->
			</div>
			<div class="element">
				<div class="etitle">商品描述:</div>
				<div class="einput"><input type="text" name="WIDbody" value="E客智慧电动车配件" readonly></div>
				<br>
<!--				<div class="mark">注意：商品描述(body)，选填(建议中文，英文，数字，不能含有特殊字符)</div>-->
			</div>
			<div class="element">
				<input id=btn_submit type="submit" class="alisubmit" value ="确认支付">
			</div>
		</form>
	</div>
	<div class="footer">
...
<script type="text/javascript" src="/Public/common/js/js/jquery.js"></script>
...
<script>
	...
	var trade_no = localStorage.getItem('trade_no');
	...
	var WIDsubject = document.getElementById("WIDsubject");
	var WIDtotal_fee = document.getElementById("WIDtotal_fee");

	if (!trade_no || !product_name || !fee) {
		alert('支付缓存数据丢失!')
	...
	WIDsubject.value = product_name;
	WIDtotal_fee.value = fee;
...
//	 out_trade_no.value = 'test'+ new Date().format("yyyyMMddhhmmss");
	...
	$('#btn_submit').click(function () {
		localStorage.setItem('trade_no', null);
