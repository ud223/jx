$(function() {
  ...
  function c() {
    ...
    if (k) {
      ...
      var n = '<iframe class="J_iframe" name="iframe' + m + '" id="left_menu_iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
      $(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").append(n);
      $(".J_menuTabs .page-tabs-content").append(p);
      g($(".J_menuTab.active"))
    }else{
      $('#left_menu_iframe' + m).attr('src', o);
    }
    return false
  }
